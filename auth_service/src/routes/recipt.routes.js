...
const {deleteReceipt,createReceipt, getAllReceipts,getReceiptsByEnrollment} = require("../controller/receipt.controller.js")
...
router.delete("/delete/receipt/:receiptId",verifyJwt,deleteReceipt)
